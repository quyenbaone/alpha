export function About() {
  ...
  return (
    <div className="container mx-auto px-6 py-12 max-w-4xl">
      <h1 className="text-4xl font-extrabold mb-12 text-center text-gray-900 dark:text-white tracking-wide">
        Về chúng tôi
      </h1>

      <section className="text-center text-gray-700 dark:text-gray-300 text-lg leading-relaxed max-w-3xl mx-auto space-y-6 px-4">
        <p className="font-semibold text-xl text-[#116466] dark:text-[#4ade80]">
      ...
      <section>
        {/* Có thể thêm hình ảnh hoặc video giới thiệu ở đây nếu muốn */}
      </section>

      <section>
        <h2 className="text-3xl font-bold mb-12 text-center text-gray-900 dark:text-white mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-14 max-w-5xl mx-auto">
          {team.map((member, idx) => (
            <div
              key={idx}
              className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-lg text-center hover:shadow-2xl transition-shadow duration-300 cursor-default"
            >
